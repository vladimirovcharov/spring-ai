...
public class InferenceTests extends BaseTestClass {
    ...
    void testingSentiment() {
        PromptTemplate promptTemplate = new PromptTemplate(sentimentPrompt, Map.of("review1", review1, "review2", review2, "review3", review3, "review4", review4, "review5", review5, "review6", review6));
    ...
    @Test
    void testingEmotion() {
        PromptTemplate promptTemplate = new PromptTemplate(emotionPrompt, Map.of("review1", review1, "review2", review2, "review3", review3, "review4", review4, "review5", review5, "review6", review6));
    ...
    void testingForAnger() {
        PromptTemplate promptTemplate = new PromptTemplate(angerTestPrompt, Map.of("review1", review1, "review2", review2, "review3", review3, "review4", review4, "review5", review5, "review6", review6));
    ...
    @Test
    void inferTopics() {
        PromptTemplate promptTemplate = new PromptTemplate(prompt, Map.of("story", story));
